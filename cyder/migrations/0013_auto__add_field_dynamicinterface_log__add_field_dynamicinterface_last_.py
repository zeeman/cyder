...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DynamicInterface.log'
        db.add_column('dynamic_interface', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'DynamicInterface.last_save_user'
        db.add_column('dynamic_interface', 'last_save_user',
        ...
        # Adding unique constraint on 'CNAME', fields ['domain', 'label']
        db.create_unique('cname', ['domain_id', 'label'])


    def backwards(self, orm):
        # Removing unique constraint on 'CNAME', fields ['domain', 'label']
        db.delete_unique('cname', ['domain_id', 'label'])
        ...
        # Deleting field 'DynamicInterface.log'
        db.delete_column('dynamic_interface', 'log')

        # Deleting field 'DynamicInterface.last_save_user'
        db.delete_column('dynamic_interface', 'last_save_user_id')
    ...
    models = {
        ...
        'cyder.dynamicinterface': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_save_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1408395311'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
