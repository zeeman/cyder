...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workgroup.log'
        db.add_column('workgroup', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Workgroup.last_save_user'
        db.add_column('workgroup', 'last_save_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Range.log'
        db.add_column('range', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Range.last_save_user'
        db.add_column('range', 'last_save_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Site.log'
        db.add_column('site', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Site.last_save_user'
        db.add_column('site', 'last_save_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Network.log'
        db.add_column('network', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Network.last_save_user'
        db.add_column('network', 'last_save_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'StaticInterface.log'
        db.add_column('static_interface', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StaticInterface.last_save_user'
        db.add_column('static_interface', 'last_save_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vrf.log'
        db.add_column('vrf', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Vrf.last_save_user'
        db.add_column('vrf', 'last_save_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vlan.log'
        db.add_column('vlan', 'log',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Vlan.last_save_user'
        db.add_column('vlan', 'last_save_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workgroup.log'
        db.delete_column('workgroup', 'log')

        # Deleting field 'Workgroup.last_save_user'
        db.delete_column('workgroup', 'last_save_user_id')

        # Deleting field 'Range.log'
        db.delete_column('range', 'log')

        # Deleting field 'Range.last_save_user'
        db.delete_column('range', 'last_save_user_id')

        # Deleting field 'Site.log'
        db.delete_column('site', 'log')

        # Deleting field 'Site.last_save_user'
        db.delete_column('site', 'last_save_user_id')

        # Deleting field 'Network.log'
        db.delete_column('network', 'log')

        # Deleting field 'Network.last_save_user'
        db.delete_column('network', 'last_save_user_id')

        # Deleting field 'StaticInterface.log'
        db.delete_column('static_interface', 'log')

        # Deleting field 'StaticInterface.last_save_user'
        db.delete_column('static_interface', 'last_save_user_id')

        # Deleting field 'Vrf.log'
        db.delete_column('vrf', 'log')

        # Deleting field 'Vrf.last_save_user'
        db.delete_column('vrf', 'last_save_user_id')

        # Deleting field 'Vlan.log'
        db.delete_column('vlan', 'log')

        # Deleting field 'Vlan.last_save_user'
        db.delete_column('vlan', 'last_save_user_id')
    ...
    models = {
        ...
        'cyder.cname': {
            'Meta': {'unique_together': "(('domain', 'label'),)", 'object_name': 'CNAME', 'db_table': "'cname'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cyder.Domain']"}),
            'fqdn': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
        ...
        'cyder.dynamicinterface': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_save_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1410291903'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'cyder.soaav': {
